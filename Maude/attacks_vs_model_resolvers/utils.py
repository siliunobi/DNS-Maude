...
def intermediary_nsdelegations_to_target(nb_delegations=10,
                                         ...
                                         target_address="'target-ans . 'com . root", nb_labels=1):
...
def target_cname_chain(ns_records_to_target, chain_length=10, nb_labels=10, target_address="'target-ans . 'com . root"):
    records_in_target = ""
    ...
    for index, ns_del in enumerate(ns_records_to_target):
        ...
        if chain_length <= 0 :
            ...
            for c in range(chain_length - 1):
                ...
                next = records_with_labels(previous_suffix=previous_suffix, previous_suffix_number=previous_suffix_number,
...
def standalone_cname_scrubbing_delay(nb_labels, cname_chain_length, target_address="'target-ans . 'com . root", nb_delegations=1):
    query_from_client = "op q : -> Query .\n"

    labels_text = ""
    if nb_labels != 0 :
        for lab in reversed(range(nb_labels - 1)):
            labels_text += "'fake" + str(lab) + " . "

    query_from_client += "eq q = query(1, " + labels_text + " 'a . 'target-ans . 'com . root, a) ."

    cname_chain_in_target =standalone_cname_chain_in_target(nb_labels=nb_labels,cname_chain_length=cname_chain_length, target_address="'target-ans . 'com . root",nb_delegations=nb_delegations)
...
def unchained_cname_chains(nb_labels=0,cname_chain_length=17, address_intermediary="'intermediary . 'com . root",
                       target_address="'target-ans . 'com . root",):
...
def simple_cname_chain(ns_records_to_target, cname_chain_length=17, address_intermediary="'intermediary . 'com . root",
                       target_address="'target-ans . 'com . root", ):
    cname_chain_target = ""
    cname_chain_intermediary = ""
...
def standalone_cname_chain_in_target(nb_labels=0,cname_chain_length=17, target_address="'target-ans . 'com . root", nb_delegations=1):
...
def dname_intermediary_nsdelegations_to_target(nb_labels=0,nb_del=10, address_to_be_delegated="'del . 'intermediary . 'com . root",
                                               target_address="'target-ans . 'com . root"):
...
def simple_dname_chain(ns_records_to_target, dname_chain_length=17, address_intermediary="'intermediary . 'com . root",
                       target_address="'target-ans . 'com . root"):
    dname_chain_target = ""
...
def dname_chain_val(ns_records_to_target, nb_label=0, dname_chain_length=17, target_address="'target-ans . 'com . root"):
    dname_chain_target = ""
...
def ns_del_and_dname_chain(nb_label=0, dname_chain_length=17, nb_del=10,
                           address_to_be_delegated="'del . 'intermediary . 'com . root",
                           target_address="'target-ans . 'com . root"):
    ns_records_text, ns_records_to_target = dname_intermediary_nsdelegations_to_target(nb_label,nb_del, address_to_be_delegated,
                                                                                       target_address)
...
def ns_del_and_dname_chain_scrubbing(nb_label=0, dname_chain_length=17, nb_del=10,
    ...
    dname_target = \
        dname_chain_val(nb_label=nb_label, ns_records_to_target=ns_records_to_target,
                        dname_chain_length=dname_chain_length, target_address="'target-ans . 'com . root")
...
def search_missing_attributes_cname(filename, missing_attributes, ns_del, cname_chain_length, nb_labels):
    ...
    # return missing_attributes, ns_del, cname_chain_length, nb_labels
