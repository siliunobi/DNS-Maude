...
import re
import time
from utils import check_folder_exists, check_subqueries, check_number_labels, intermediary_nsdelegations_to_target, \
    check_cname_chain_length, target_cname_chain, run_file, cname_chain_val_delay, simple_cname_chain, \
    unchained_cname_chains
import utils
            ...
            for labels in RANGE_LABELS:
                for ns_del in RANGE_NS_DELEGATIONS:
                    ...
                    for cname_chain_length in RANGE_CNAME_LENGTH:
                        ...
                        cname_chain_intermediary, cname_chain_in_target = unchained_cname_chains(nb_labels=labels,
                        ...
                        whole = variant.whole_file(PATH_TO_MAIN_DIR, resolver_model, qmin_deactivated,
                                                   cname_chain_in_target, cname_chain_intermediary)
